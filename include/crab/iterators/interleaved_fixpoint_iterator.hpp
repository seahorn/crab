...
public:
  ...
  typedef std::unordered_map<basic_block_label_t, AbstractValue>
      assumption_map_t;
  typedef std::unordered_map<basic_block_label_t, AbstractValue>
      invariant_table_t;

private:
  typedef interleaved_fwd_fixpoint_iterator_impl::wto_iterator<CFG,
                                                               AbstractValue>
      wto_iterator_t;
  typedef interleaved_fwd_fixpoint_iterator_impl::wto_processor<CFG,
                                                                AbstractValue>
      wto_processor_t;
...
public:
  typedef interleaved_fwd_fixpoint_iterator<CFG, AbstractValue>
