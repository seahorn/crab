    ...
    private:
	 ...
	 public:
	   ...
	   apply_separate(const this_type& o): f (o.f) {}
       	   ...
       	   separate_domain_t operator()(separate_domain_t inv)
       	   { // XXX: separate_domain_t cannot be modified in-place
	     typedef std::pair<typename separate_domain_t::key_type,
			       typename separate_domain_t::value_type> value_type;     
	 ...
	 basic_block_t &_bb;
       ...
       public:
         ...
         transfer_function (separate_domain_t inv, const cdg_t &g,
			    assert_map_t &am, basic_block_t &bb)
	 ...
	 return separate_domain_t::bottom();
       ...
       virtual separate_domain_t merge(separate_domain_t d1, separate_domain_t d2) override {
	 return d1 | d2;
       }
