...
private:
  ...
  typedef typename boost::graph_traits<scc_graph_t>::vertex_descriptor
      vertex_descriptor_t;
  typedef typename boost::graph_traits<scc_graph_t>::edge_descriptor
      edge_descriptor_t;
  typedef typename boost::graph_traits<scc_graph_t>::vertex_iterator
      vertex_iterator;
  typedef typename boost::graph_traits<scc_graph_t>::out_edge_iterator
      out_edge_iterator;
  typedef typename boost::graph_traits<scc_graph_t>::in_edge_iterator
      in_edge_iterator;
  /// --- end internal representation of the scc_graph

  typedef std::unordered_map<node_t, std::size_t> component_map_t;
  typedef std::unordered_map<std::size_t, vertex_descriptor_t>
      comp_to_vertex_map_t;
  typedef std::unordered_map<std::size_t, std::vector<node_t>>
      comp_members_map_t;
