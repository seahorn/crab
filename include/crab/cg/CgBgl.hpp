...
namespace boost {
  ...
  template<class CG>
  struct graph_traits < crab::cg::CallGraph_Ref<CG> >  {
    typedef crab::cg::CallGraph_Ref<CG> cg_ref_t;
...
namespace crab {
  ...
  // --- Functions for crab::cg::CallGraph
  ...
  // --- Functions for crab::cg::CallGraph_Ref

  template<class CG> 
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor
  source (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::edge_descriptor e, 
          const crab::cg::CallGraph_Ref<CG> &g) {
    return e.Src (); 
  } 

  template<class CG>
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor
  target (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::edge_descriptor e, 
          const crab::cg::CallGraph_Ref<CG> &g) {
    return e.Dest ();
  }

  template<class CG>
  std::pair< typename graph_traits< crab::cg::CallGraph_Ref<CG> >::in_edge_iterator, 
             typename graph_traits< crab::cg::CallGraph_Ref<CG> >::in_edge_iterator >
  in_edges (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor v, 
            const crab::cg::CallGraph_Ref<CG> &g) {
    return g.preds (v);
  }

  template<class CG>
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::degree_size_type
  in_degree (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor v, 
             const crab::cg::CallGraph_Ref<CG> &g) {
    return g.num_preds (v);
  }

  template<class CG>
  std::pair< typename graph_traits< crab::cg::CallGraph_Ref<CG> >::out_edge_iterator, 
             typename graph_traits< crab::cg::CallGraph_Ref<CG> >::out_edge_iterator >
  out_edges (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor v, 
             const crab::cg::CallGraph_Ref<CG> &g) {
    return g.succs (v);
  }
  ...
  template<class CG>
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::degree_size_type
  out_degree (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor v, 
              const crab::cg::CallGraph_Ref<CG> &g) { 
    return g.num_succs (v);
  }
  ...
  template<class CG>
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::degree_size_type
  degree (typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_descriptor v, 
          const crab::cg::CallGraph_Ref<CG> &g) {
    return g.num_preds (v) + g.num_succs (v);
  }

  template<class CG>
  std::pair<typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_iterator, 
            typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertex_iterator > 
  vertices (const crab::cg::CallGraph_Ref<CG> &g) {
    return g.nodes ();
  }
  
  template<class CG>
  typename graph_traits< crab::cg::CallGraph_Ref<CG> >::vertices_size_type
  num_vertices (const crab::cg::CallGraph_Ref<CG> &g) {
    return g.num_nodes ();
  }
