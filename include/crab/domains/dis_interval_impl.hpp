...
dis_interval<Number> dis_interval<Number>::top() {
  return dis_interval<Number>(dis_interval<Number>::TOP);
}

template<typename Number>
dis_interval<Number> bottom() {
  return dis_interval<Number>(dis_interval<Number>::BOT);
}

// REVISIT: this is correct only if Number=z_number
template<typename Number>  
bool dis_interval<Number>::are_consecutive(const ikos::interval<Number> &i1, const ikos::interval<Number> &i2) const {
...
template<typename Number>  
bool dis_interval<Number>::overlap(const ikos::interval<Number> &i1, const ikos::interval<Number> &i2) const {
    return !((i1 & i2).is_bottom());
}

template<typename Number>
struct IsOnTheLeft {
  bool operator()(const ikos::interval<Number> &i1, const ikos::interval<Number> &i2) const {
    return ((i1.ub() <= i2.lb()) && (i1.ub() != i2.lb()));
  }
};

template<typename Number>    
bool dis_interval<Number>::check_well_formed(const dis_interval<Number> &x) const {
...
template<typename Number>    
typename dis_interval<Number>::list_intervals_t
dis_interval<Number>::normalize(typename dis_interval<Number>::list_intervals_t l, bool &is_bottom) const {
  ...
  std::sort(l.begin(), l.end(), [](const ikos::interval<Number> &a, const ikos::interval<Number> &b) {
...
template<typename Number>  
dis_interval<Number>::dis_interval(typename dis_interval<Number>::list_intervals_t l,
  ...
  if (apply_normalize) {
    ...
    typename dis_interval<Number>::list_intervals_t res = normalize(m_list, is_bottom);
    if (is_bottom) {
      m_state = BOT;
        m_list.clear();
    } else if (res.empty()) {
  ...
  // pre: x is normalized
template<typename Number>  
ikos::interval<Number> dis_interval<Number>::approx(typename dis_interval<Number>::list_intervals_t x) const {
  if (x.empty())
...
template<typename Number>
bool dis_interval<Number>::is_bottom() const { return (m_state == BOT); }

template<typename Number>  
bool dis_interval<Number>::is_top() const { return (m_state == TOP); }

template<typename Number>  
bool dis_interval<Number>::is_finite() const { return (m_state == FINITE); }
...
dis_interval<Number> dis_interval<Number>::lower_half_line() const {
  if (is_bottom()) {
    ...
    auto f = [](ikos::interval<Number> x) -> ikos::interval<Number> { return x.lower_half_line(); };
...
dis_interval<Number> dis_interval<Number>::upper_half_line() const {
  if (is_bottom()) {
    ...
    auto f = [](ikos::interval<Number> x) -> ikos::interval<Number> { return x.upper_half_line(); };
    return apply_unary_op(*this, f);
  }
}
...
template<typename Number>  
typename dis_interval<Number>::iterator dis_interval<Number>::begin() { return m_list.begin(); }

template<typename Number>  
typename dis_interval<Number>::iterator dis_interval<Number>::end() { return m_list.end(); }

template<typename Number>  
typename dis_interval<Number>::const_iterator dis_interval<Number>::begin() const { return m_list.begin(); }

template<typename Number>  
typename dis_interval<Number>::const_iterator dis_interval<Number>::end() const { return m_list.end(); }
...
// pre: *this and o are normalized
template<typename Number>  
dis_interval<Number> dis_interval<Number>::operator|(const dis_interval<Number> &o) const {
...
dis_interval<Number>::BasicWidenOp::
apply(const ikos::interval<Number> &before, const ikos::interval<Number> &after) {
  return before || after;
}

template<typename Number>
dis_interval<Number>::WidenWithThresholdsOp::WidenWithThresholdsOp(const thresholds<Number> &ts)
  : m_ts(ts) {}

template<typename Number>  
ikos::interval<Number>
dis_interval<Number>::WidenWithThresholdsOp::
apply(const ikos::interval<Number> &before, const ikos::interval<Number> &after) {
  return before.widening_thresholds(after, m_ts);
}

template<typename Number>  
dis_interval<Number> dis_interval<Number>::
widening(const dis_interval<Number> &o, WidenOp &widen_op) const {
  if (this->is_bottom()) {
    return o;
  } else if (o.is_bottom()) {
    return *this;
    ...
    ikos::interval<Number> ub_widen =
      widen_op.apply(m_list[m_list.size() - 1], o.m_list[o.m_list.size() - 1]);
...
template <typename Number>
dis_interval<Number> dis_interval<Number>::
widening_thresholds(const dis_interval<Number> &o, const thresholds<Number> &ts) const {
...
template <typename Number>
dis_interval<Number> dis_interval<Number>::
apply_bin_op(const dis_interval<Number> &x, const dis_interval<Number> &y,
  ...
  if (shortcut_top || (x.is_finite() && y.is_finite())) {
	...
	(is_non_top_left ? op(non_top_arg.m_list[i], ikos::interval<Number>::top())
...
template <typename Number>
dis_interval<Number> dis_interval<Number>::
apply_unary_op(const dis_interval<Number> &x,
...
template<typename Number>
dis_interval<Number> dis_interval<Number>::operator+(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a + b; };
      return apply_bin_op(*this, x, f, true);
    }
  }

template<typename Number>  
  dis_interval<Number> &dis_interval<Number>::operator+=(const dis_interval<Number> &x) {
...
template<typename Number>  
  dis_interval<Number> dis_interval<Number>::operator-() const {
    if (this->is_bottom()) {
      ...
      auto f = [](ikos::interval<Number> a) -> ikos::interval<Number> { return -a; };
      return apply_unary_op(*this, f);
    }
  }
...
template<typename Number>
dis_interval<Number> dis_interval<Number>::UDiv(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a / b; };
...
template<typename Number>  
dis_interval<Number> dis_interval<Number>::SRem(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.SRem(b); };
      return apply_bin_op(*this, x, f, false);
    }
  }

template<typename Number>  
dis_interval<Number> dis_interval<Number>::URem(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.URem(b); };
      return apply_bin_op(*this, x, f, false);
    }
}
...
template<typename Number>  
dis_interval<Number> dis_interval<Number>::And(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.And(b); };
      return apply_bin_op(*this, x, f, false);
    }
  }

template<typename Number>  
dis_interval<Number> dis_interval<Number>::Or(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.Or(b); };
      return apply_bin_op(*this, x, f, false);
    }
  }

template<typename Number>  
dis_interval<Number> dis_interval<Number>::Xor(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.Xor(b); };
      return apply_bin_op(*this, x, f, false);
    }
  }
...
template<typename Number>  
dis_interval<Number> dis_interval<Number>::Shl(const dis_interval<Number> &x) const {
    if (this->is_bottom() || x.is_bottom()) {
      return this->bottom();
    } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.Shl(b); };
      return apply_bin_op(*this, x, f, false);
    }
  }

template<typename Number>  
dis_interval<Number> dis_interval<Number>::LShr(const dis_interval<Number> &x) const {
  if (this->is_bottom() || x.is_bottom()) {
    return this->bottom();
  } else {
      auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.LShr(b); };
      return apply_bin_op(*this, x, f, false);
  }
}

template<typename Number>  
dis_interval<Number> dis_interval<Number>::AShr(const dis_interval<Number> &x) const {
  if (this->is_bottom() || x.is_bottom()) {
    return this->bottom();
  } else {
    auto f = [](ikos::interval<Number> a, ikos::interval<Number> b) { return a.AShr(b); };
    return apply_bin_op(*this, x, f, false);
  }
}
     
template<typename Number>  
void dis_interval<Number>::normalize() {
    if (is_bottom() || is_top())
      return;
    bool is_bot = false;
    typename dis_interval<Number>::list_intervals_t res = normalize(m_list, is_bot);
...
template<typename Number>  
void dis_interval<Number>::write(crab_os &o) const {
    if (is_bottom()) {
      o << "_|_";
    } else if (is_top()) {
      o << "[-oo,+oo]";
      ...
      for (typename dis_interval<Number>::list_intervals_t::const_iterator
	     it = m_list.begin(), et = m_list.end(); it != et;) {
        o << *it;
        ++it;
        if (it != et)
          o << " | ";
