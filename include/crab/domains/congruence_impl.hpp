...
void congruence<Number>::normalize(void) {
...
template<typename Number>    
Number congruence<Number>::abs(Number x) const { return x < 0 ? -x : x; }

template<typename Number>    
Number congruence<Number>::max(Number x, Number y) const { return (x <= y) ? y : x; }

template<typename Number>    
Number congruence<Number>::min(Number x, Number y) const { return (x < y) ? x : y; }

template<typename Number>    
Number congruence<Number>::gcd(Number x, Number y, Number z) const { return gcd(x, gcd(y, z)); }
...
template<typename Number>    
Number congruence<Number>::gcd(Number x, Number y) const { return gcd_helper(abs(x), abs(y)); }
...
template<typename Number>    
bool congruence<Number>::is_zero() const { return !is_bottom() && m_a == 0 && m_b == 0; }

template<typename Number>    
bool congruence<Number>::all_ones() const { return !is_bottom() && m_a == 0 && m_b == -1; }

template<typename Number>  
congruence<Number> congruence<Number>::top() { return congruence(true); }

template<typename Number>    
congruence<Number> congruence<Number>::bottom() { return congruence(false); }
...
template<typename Number>      
bool congruence<Number>::is_bottom() const { return m_is_bottom; }

template<typename Number>      
bool congruence<Number>::is_top() const { return m_a == 1; }
...
template<typename Number>        
Number congruence<Number>::get_modulo() const {
  return m_a;
}
  
template<typename Number>      
Number congruence<Number>::get_remainder() const {
  return m_b;
}
...
template<typename Number>      
bool congruence<Number>::operator!=(const congruence<Number> &x) const { return !this->operator==(x); }
...
template<typename Number>
congruence<Number> congruence<Number>::operator|(const congruence<Number> &o) const {
  if (is_bottom()) {
    return o;
  } else if (o.is_bottom()) {
      return *this;
