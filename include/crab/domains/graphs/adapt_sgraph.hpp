  ...
  class AdaptSMap {
    ...
    public:
      ...
      AdaptSMap& operator=(AdaptSMap&& o)
      {
        ...
        dense = o.dense; o.dense = nullptr;
        sparse = o.sparse; o.sparse = nullptr;
	...
	static key_iter_t empty_iterator () { 
      ...
      public:
        ...
        key_range_t(elt_t* _e, size_t _sz)
          : e(_e), sz(_sz)
        { }
        size_t size(void) const { return sz; }
      ...
      public:
        ...
        elt_range_t(elt_t* _e, size_t _sz)
          : e(_e), sz(_sz)
        { }
        elt_range_t(const elt_range_t& o)
          : e(o.e), sz(o.sz)
        { }
        size_t size(void) const { return sz; }
  ...
  public:  
    ...
    public:
      ...
      edge_range_t(const edge_range_t& o)
        : r(o.r), ws(o.ws)
      { }
      edge_range_t(const elt_range_t& _r, vec<Wt>& _ws)
        : r(_r), ws(_ws)
      { }
    ...
    bool elem(vert_id s, vert_id d)
    {
      return _succs[s].elem(d);
    }
