...
public:
  ...
  void operator|=(boxes_domain_t other) { CRAB_ERROR(LDD_NOT_FOUND); }

  boxes_domain_t operator|(boxes_domain_t other) { CRAB_ERROR(LDD_NOT_FOUND); }
  ...
  void operator-=(variable_t var) { CRAB_ERROR(LDD_NOT_FOUND); }

  interval_t operator[](variable_t v) { CRAB_ERROR(LDD_NOT_FOUND); }

  void set(variable_t v, interval_t ival) { CRAB_ERROR(LDD_NOT_FOUND); }
  ...
  void assume_bool(variable_t v, bool is_negated) { CRAB_ERROR(LDD_NOT_FOUND); }
  ...
  void pointer_mk_null(variable_t lhs) { CRAB_ERROR(LDD_NOT_FOUND); }

  void pointer_assume(pointer_constraint_t cst) { CRAB_ERROR(LDD_NOT_FOUND); }

  void pointer_assert(pointer_constraint_t cst) { CRAB_ERROR(LDD_NOT_FOUND); }

  void forget(const variable_vector_t &variables) { CRAB_ERROR(LDD_NOT_FOUND); }

  void project(const variable_vector_t &variables) {
    CRAB_ERROR(LDD_NOT_FOUND);
  }

  void expand(variable_t var, variable_t new_var) { CRAB_ERROR(LDD_NOT_FOUND); }

  void normalize() { CRAB_ERROR(LDD_NOT_FOUND); }

  void minimize() { CRAB_ERROR(LDD_NOT_FOUND); }
  ...
  void write(crab_os &o) { CRAB_ERROR(LDD_NOT_FOUND); }

  static std::string getDomainName() { return "Dummy Boxes"; }
};
} // namespace domains
} // namespace crab
...
public:
  ...
  bool is_bottom() { return &*m_ldd == Ldd_GetFalse(get_ldd_man()); }

  bool is_top() { return &*m_ldd == Ldd_GetTrue(get_ldd_man()); }
  ...
  void operator|=(boxes_domain_t other) { *this = *this | other; }
