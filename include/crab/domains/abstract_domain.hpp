...
namespace crab {
  ...
  namespace domains {
	...
	return abs;
      ...
      // lhs := rhs      otherwise
      virtual void assign_bool_var(variable_t lhs, variable_t rhs, bool is_not_rhs) = 0;
      // x := y op z
      virtual void apply_binary_bool(bool_operation_t op, variable_t x,variable_t y,variable_t z) = 0;				     
