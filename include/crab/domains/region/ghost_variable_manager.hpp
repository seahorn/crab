...
/// Choose statically the ghost variable manager  
template<typename Domain, typename GhostDomain, typename GhostDomainVarAlloc>
using ghost_variable_manager =
  // std::conditional<std::is_same<typename Domain::varname_t, typename GhostDomain::varname_t>::value,
  // 		   ghost_variable_manager_with_fixed_naming<Domain>,
  // 		   ghost_variable_manager_with_variable_naming<Domain, GhostDomain, GhostDomainVarAlloc>>; 
  ghost_variable_manager_with_variable_naming<Domain, GhostDomain, GhostDomainVarAlloc>;
 ...
 *  ------------------------------
 * 
 * This domain configuration breaks the array_smashing domain becuase
...
private:
  ...
  ghost_variables_t insert_ghost_vars(const variable_t &v) {
    auto gvars = ghost_variables_t::create(m_alloc, m_get_type(v));
...
public:
  ...
  void project_and_meet(const variable_vector_t &variables,
	...
	ghost_variables_t new_right_gvars =
	  ghost_variables_t::create(right_alloc, m_get_type(v));
  ...
  ghost_variables_t dup(const ghost_variables_t &gvars)  {
    return ghost_variables_t::create(m_alloc, gvars);
  }
