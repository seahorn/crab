 ...
 *
 * The construction of weak topological orderings is based on
 * F. Bourdoncle's paper: "Efficient chaotic iteration strategies with
 * widenings", Formal Methods in Programming and Their Applications,
 * 1993, pages 128-141.
 *
 ******************************************************************************/
