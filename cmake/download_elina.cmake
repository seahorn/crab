...
if (GIT_FOUND)
 find_package(SSE)
  ...
  ExternalProject_Add(elina
    ...
    CONFIGURE_COMMAND ${CRAB_EP_ENV} ./configure -prefix ${INSTALL_DIR} -use-vector  -gmp-prefix ${GMP_SEARCH_PATH} -mpfr-prefix ${MPFR_SEARCH_PATH}
    BUILD_IN_SOURCE 1
    BUILD_COMMAND ${CRAB_EP_ENV} make "CC=${CMAKE_C_COMPILER} ${CRAB_EP_CC_COMPAT}" CXX=${CMAKE_CXX_COMPILER} ${IS_VECTOR} ${IS_SSE}
    ELINA_PREFIX=<INSTALL_DIR> GMP_PREFIX=${GMP_SEARCH_PATH} MPFR_PREFIX=${MPFR_SEARCH_PATH}
    INSTALL_COMMAND
    ${CRAB_EP_ENV} make ELINA_PREFIX=<INSTALL_DIR> GMP_PREFIX=${GMP_SEARCH_PATH} MPFR_PREFIX=${MPFR_SEARCH_PATH} install
    LOG_CONFIGURE 1
    LOG_INSTALL 1
    LOG_BUILD 1)
else ()
