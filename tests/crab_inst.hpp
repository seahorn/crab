...
#include "./crab.hpp"
#include "./domains/object/object_dom.hpp"

// Here all explicit instantiations

#define Z_RUNNER(DOM)                                                          \
  template void z_intra_run<DOM>(                                              \
      const crab::cfg_impl::z_cfg_t&, crab::cfg_impl::basic_block_label_t, DOM,     \
      bool, unsigned, unsigned, unsigned, bool, bool, bool);

#define Q_RUNNER(DOM)                                                          \
  template void q_intra_run<DOM>(                                              \
      const crab::cfg_impl::q_cfg_t&, crab::cfg_impl::basic_block_label_t, DOM,     \
      bool, unsigned, unsigned, unsigned, bool, bool, bool);
...
Z_RUNNER(crab::domain_impl::z_tvpi_dbm_domain_t)
...
Z_RUNNER(crab::object_domain_impl::z_obj_sdbm_t)
Z_RUNNER(crab::object_domain_impl::z_obj_zones_t)
Z_RUNNER(crab::object_domain_impl::z_obj_pk_t)
