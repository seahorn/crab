...
int main(int argc, char **argv) {
  ...
  */
  ...
  inv1.ref_make(A2, rgn1, size12, as_man.mk_tag());
  inv1.ref_store(p, rgn1, five32); // store_ref(V_a, p, 5)
  inv1.ref_store(r, rgn2, ten32); // store_ref(V_b, r, 10)
  /* inv1:
  base: { 0 < objA && p = objA && r = p + 4 && V_a = 0 && V_b = 1 },
  addrs: { objA == p && objA == q },
  uf_regs: {},
  odi_map: 
    objA(
