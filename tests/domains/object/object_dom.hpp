...
using z_obj_sdbm_params_t = TestObjectParams<flat_boolean_numerical_domain<
...
using z_obj_zones_params_t = TestObjectParams<flat_boolean_numerical_domain<domain_impl::z_soct_domain_t>>;
using z_obj_zones_t = object_domain<z_obj_zones_params_t>;
using z_obj_pk_params_t = TestObjectParams<flat_boolean_numerical_domain<domain_impl::z_pk_elina_domain_t>>;
using z_obj_pk_t = object_domain<z_obj_pk_params_t>;
} // namespace object_domain_impl
} // namespace crab