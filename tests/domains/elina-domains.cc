...
int main(int argc, char **argv) {
...

  {
    ...
    auto cfg = prog1(vfac);
    crab::outs() << *cfg << "\n";
    run_all<z_oct_elina_domain_t, z_pk_elina_domain_t>(cfg, stats_enabled);
  }

  {
    ...
    auto cfg = prog2(vfac);
    crab::outs() << *cfg << "\n";
    run_all<z_zones_elina_domain_t, z_oct_elina_domain_t, z_pk_elina_domain_t>(cfg, stats_enabled);
  }
