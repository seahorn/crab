...
int main(int argc, char** argv) {
  ...
  #ifdef HAVE_APRON
  {
    ...
    backward_run<z_ae_box_apron_t>(cfg,cfg->entry(),initial_states,1,2,20,stats_enabled);
  }
  #endif

  {
    ...
    backward_run<z_ae_int_t>(cfg,cfg->entry(),initial_states,1,2,20,stats_enabled);
  }
