...
int main(int argc, char**argv) {
  ...
  crab::analyzer::assumption_naive_analysis<z_cfg_ref_t> assumption_naive_analyzer(*p);
  assumption_naive_analyzer.exec();
  crab::outs() << "\n" << assumption_naive_analyzer << "\n";

  crab::analyzer::assumption_dataflow_analysis<z_cfg_ref_t> assumption_dataflow_analyzer(*p);
